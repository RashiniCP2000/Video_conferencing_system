              ...
              {sidebarItems.map((item) => (
                <li key={item.label} style={st.sidebarItem}>
                  <button
                    ...
                    style={{
                      ...st.sidebarBtn,
                      background: item.label === "Meetings" ? "var(--sidebar-active-bg, #eff6ff)" : "none",
                      color:      item.label === "Meetings" ? "var(--sidebar-active-color, #1a6ff4)" : "var(--sidebar-text, #1e293b)",
                      fontWeight: item.label === "Meetings" ? "600"     : "500",
                    }}
                  >
